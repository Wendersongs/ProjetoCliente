...
public class ControleMarcas {
    ...
    private static ControleMarcas objCtrl;
    private ClienteTCP ligacaoCliente = null;
    private Object CharSource;
  

    private ControleMarcas() throws IOException {
    ...
    public void incluirDadosPersistencia(Object objeto, int operacao) throws Exception {
        ...
        public ArrayList<Marcas> recuperar(String fr) throws Exception {
        try {
    ...
    public static ControleMarcas getInstance() throws IOException{
        if(objCtrl == null){
            objCtrl = new ControleMarcas();
        }
        return objCtrl;
    }
}
